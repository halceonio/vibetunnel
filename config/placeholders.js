...
module.exports = {
  ...
  packageDir: {
    orchestration_guide: path.join('.codemachine', 'prompts', 'orchestration', 'guide.md'),
    arch_output_format: path.join('.codemachine', 'prompts', 'templates', 'codemachine', 'output-formats', 'architecture-output.md'),
    plan_output_format: path.join('.codemachine', 'prompts', 'templates', 'codemachine', 'output-formats', 'planning-output.md'),
    task_output_format: path.join('.codemachine', 'prompts', 'templates', 'codemachine', 'output-formats', 'task-breakdown-output.md'),
    context_output_format: path.join('.codemachine', 'prompts', 'templates', 'codemachine', 'output-formats', 'context-output.md'),
    task_validation_output_format: path.join('.codemachine', 'prompts', 'templates', 'codemachine', 'output-formats', 'task-validation-output.md'),
